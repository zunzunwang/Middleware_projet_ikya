		...
		// TODO Auto-generated method stub
		   try {
			...
			if(ismyfriendOnline.is_online(to_userId)){
				JOptionPane.showMessageDialog(null,"He is online,We will pass a demande directely","Alert", JOptionPane.WARNING_MESSAGE);			
				}else{
					JOptionPane.showMessageDialog(null,"He is not online, we will pass a demande","Alert", JOptionPane.WARNING_MESSAGE);
					Set_defisapply  setdefisapply =(Set_defisapply)context.lookup("Set_defisapply");
					setdefisapply.createdefisapply(from_userId, to_userId);
				}			
